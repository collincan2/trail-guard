...
SEGMENT = {
    ...
    2: {"name": "Picnic Area", "traffic_multiplier": 1.5},
    3: {"name": "Close Paved Loops", "traffic_multiplier": 1.2},
...
def get_segmentInfo(segment_id: int) -> dict:
    return SEGMENT.get(segment_id, {"name": "Unknown Segment", "traffic_multiplier": 1.0})